...
const GenerateBtn = () => {
    ...
    return (
        <motion.div className='pb-16 text-center' initial={{ opacity: 0.2, y: 100 }} transition={{ duration: 1 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <button onClick={onClickHandler} className='inline-flex items-center gap-2 text-white bg-black m-auto mt-8 px-12 py-3 rounded-full hover:scale-105 transition-all duration-500 cursor-pointer'>Generate Images
